...
pub fn add_vec_u8_to_amb(amb: &mut Amb, file_name: &str, file_data: &[u8], new_name: Option<String>) -> Result<(), CommonBinaryError> {
...
pub fn add_file_to_amb(amb: &mut Amb, file_to_add: &Path, internal_file_name: Option<String>) -> Result<(), CommonBinaryError> {
