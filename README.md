...
* Give amb-rs a try, it properly handles big endian files and should be more stable than AMBPatcher (amb-rs is now part of [the tools repository](https://github.com/OSA413/Sonic4_Tools), check its [release page](https://github.com/OSA413/Sonic4_Tools/releases)).
